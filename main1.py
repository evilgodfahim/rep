#!/usr/bin/env python3
"""
Global Intelligence RSS Feed Processor

Fetches all feeds, deduplicates by link, sends titles to Gemini.
Gemini filters for genuinely significant global developments
across 13 intelligence domains.
...
try:
    from googlenewsdecoder import gnewsdecoder as _gnews_decoder
    _GNEWS_DECODER_API = "new"
except ImportError:
    try:
        from googlenewsdecoder import new_decoderv1 as _gnews_decoder
        _GNEWS_DECODER_API = "old"
    except ImportError:
        _gnews_decoder = None
        _GNEWS_DECODER_API = None
